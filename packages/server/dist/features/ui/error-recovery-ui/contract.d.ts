 ...
 */
export declare const ErrorRecoveryContractValidation: {
    readonly automation: {
        readonly transparentRecoveryRate: 0.95;
        readonly userVisibleErrorsMax: 0.05;
        readonly statePreservationRequired: true;
    };
    readonly transparency: {
        readonly transparentRetriesRequired: true;
        readonly fallbackRoutingRequired: true;
        readonly gracefulDegradationRequired: true;
    };
    readonly usability: {
        readonly minimalDisruption: true;
        readonly actionableMessaging: true;
        readonly persistentSettings: true;
    };
};
