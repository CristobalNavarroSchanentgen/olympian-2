...
export interface MessageFlowValidationResult {
    ...
    responsiveness: {
        sendButtonFeedback: boolean;
        inputResponsiveness: boolean;
        scrollSmoothness: boolean;
    };
    naturalness: {
        messageOrganization: boolean;
        timestampClarity: boolean;
        conversationFlow: boolean;
    };
    smoothness: {
        animationQuality: boolean;
        noJarringBehavior: boolean;
        immediateInteractions: boolean;
    };
 ...
 */
export declare const MessageFlowContractValidation: {
    readonly responsiveness: {
        readonly sendButtonLatencyMaxMs: 50;
        readonly inputLatencyMaxMs: 16;
        readonly scrollSmoothnesRequired: true;
    };
    readonly naturalness: {
        readonly intuitiveBubbleLayout: true;
        readonly timestampVisibility: true;
        readonly conversationContinuity: true;
    };
    readonly interactionQuality: {
        readonly smoothAnimations: true;
        readonly predictableBehavior: true;
        readonly immediateResponse: true;
    };
};
