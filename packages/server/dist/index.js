...
async function startServer() {
    try {
        ...
        const titleGenerationService = new TitleGenerationServiceImpl();
        ...
        const textModelSelector = createTextModelSelector(modelRegistryService, textModelFilterAdapter, selectionPersistenceAdapter);
        const visionModelSelector = createVisionModelSelector(modelRegistryService, visionModelFilterAdapter, selectionPersistenceAdapter, imageDetectionAdapter);
        ...
        // Initialize WebSocket handler with all services
        const webSocketHandler = new WebSocketHandler(io, conversationService, messageService, mcpManager, ollamaService, textModelSelector, visionModelSelector, titleGenerationService);
