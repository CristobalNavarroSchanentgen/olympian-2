...
const streaming_service_impl_1 = require("./services/streaming-service-impl"); // Registry-aware model service imports
...
async function startServer() {
    try {
        ...
        const layoutService = new layout_service_impl_1.LayoutServiceImpl(); // Initialize MCP Manager
