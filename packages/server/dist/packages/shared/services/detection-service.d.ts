...
export interface DetectionService {
     ...
     */
    detectCapabilities(connectionId: string, modelName: string, method?: 'auto' | 'manual'): Promise<DetectionResult>;
    /**
     * Detect capabilities for all models
     */
    detectAllCapabilities(connectionId: string, method?: 'auto' | 'manual'): Promise<DetectionResult[]>;
    /**
     ...
     */
    saveCapabilities(modelName: string, capabilities: ModelCapability): Promise<boolean>;
    /**
     * Override model capabilities
     */
    overrideCapabilities(modelName: string, overrides: Partial<ModelCapability>): Promise<boolean>;
    /**
     ...
     */
    testCapability(connectionId: string, modelName: string, capability: 'vision' | 'streaming' | 'tools' | 'chat'): Promise<boolean>;
    /**
