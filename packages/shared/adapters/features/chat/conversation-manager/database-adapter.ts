...
export interface DatabaseAdapter {
  ...
  countByModel(): Promise<{ model: string; count: number }[]>;
}

export function createDatabaseAdapter(connection: any): DatabaseAdapter {
  return {
...
function transformFromDb(doc: any): Conversation {
  return {
    id: doc._id.toString(),
    title: doc.title,
    model: doc.model,
