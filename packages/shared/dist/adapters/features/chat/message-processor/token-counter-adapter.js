...
function countMessageTokensHelper(message) {
...
function estimateResponseTokensHelper(prompt, model) {
...
function trimToFitBudgetHelper(messages, budget) {
    const checkBudget = (msgs) => {
...
function getTokenStatsHelper(messages) {
...
function calculateCostHelper(tokens, model) {
...
export function createTokenCounterAdapter() {
    return {
